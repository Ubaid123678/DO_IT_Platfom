...
export const kycController = {
  getProviderStatus: asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    res.status(200).json({ success: true, data: status, meta: { message: 'KYC status fetched successfully.' } });
  }),
  ...
  getRestrictedAccess: asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    res.status(200).json({ success: true, data: result, meta: { message: 'KYC access state fetched successfully.' } });
  }),
  ...
  submitKyc: asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    res.status(201).json({ success: true, data: { document }, meta: { message: 'KYC submitted successfully. Pending review.' } });
  }),
  ...
  resubmitKyc: asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    res.status(201).json({ success: true, data: { document }, meta: { message: 'KYC resubmitted successfully. Pending review.' } });
  }),
  ...
  listSubmissions: asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    res.status(200).json({ success: true, data: { submissions }, meta: { message: 'KYC submissions fetched successfully.' } });
  }),
  ...
  approveSubmission: asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    res.status(200).json({ success: true, data: result, meta: { message: 'KYC submission approved successfully.' } });
  }),
  ...
  rejectSubmission: asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    ...
    res.status(200).json({ success: true, data: result, meta: { message: 'KYC submission rejected successfully.' } });
  }),

  getSubmissionDetail: asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
    const reviewerId = getAuthenticatedUserId(req);
    const detail = await kycService.getSubmissionDetail(reviewerId, req.params.userId);
    res.status(200).json({ success: true, data: detail, meta: { message: 'KYC submission detail fetched successfully.' } });
  }),
};
